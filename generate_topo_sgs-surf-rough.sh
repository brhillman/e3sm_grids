...
smoothed_topography_file=/project/projectdirs/acme/${user}/preqx/template/USGS-gtopo30_ne0np4_12xdel2.nc
...
# run the code
echo "Run cube_to_target to comput subgrid-scale surface roughness..."
...
echo "Done running cube_to_target to compute subgrid-scale surface roughness..."
