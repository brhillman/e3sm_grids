...
parser.add_option('--vgrid_file', dest='vgrid_file',    default=None,help='Sets the output vertical grid file')
...
dst_horz_grid = 'arcticx4v1'

# Specify output atmosphere vertical grid
dst_vert_grid, vert_file_name = 'L72', 'files_vert/vert_coord_E3SM_L72.nc'

# Specify date of data
init_date = '2010-01-01'

# Extract year of data (for SST and ice)
init_year = int(init_date.split('-')[0])

# Specify output file names
data_root = '/sems-data-store/ACME/bhillma/HICCUP/data/'
...
topo_file_name = f'/sems-data-store/ACME/bhillma/grids/arcticx4v1pg2/USGS-gtopo30_arcticx4v1pg2_12xdel2_20210723.nc'
...
# Set grid and mapping files by hand?
#hiccup_data.src_grid_name = None
#hiccup_data.src_grid_file = None
hiccup_data.dst_horz_grid = 'arcticx4v1pg2'
hiccup_data.dst_grid_file = '/sems-data-store/ACME/bhillma/grids/arcticx4v1pg2/arcticx4v1.g'
#hiccup_data.map_file = None
